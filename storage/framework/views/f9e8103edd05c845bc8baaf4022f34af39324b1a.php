                                ...
                                <div class="card-block m-t-35">
                                    <div>
                                        <div class="nav-tabs-custom">
                                            <ul class="nav nav-tabs" style="color: #8dc647;">
                                                <li class="nav-item" style="min-width: 300px;text-align: center;">
                                                    <a href="#tab_2" class="nav-link active" data-toggle="tab"  style="color: #8dc647;">Upcoming</a>
                                                </li>
                                                <li class="nav-item" style="min-width: 300px;text-align: center;">
                                                    <a href="#tab_1" class="nav-link" data-toggle="tab"  style="color: #8dc647;">On going</a>
                                                </li>
                                                <li class="nav-item" style="min-width: 300px;text-align: center;">
                                                    <a href="#tab_3" class="nav-link" data-toggle="tab"  style="color: #8dc647;">Ended</a>
                                                </li>
