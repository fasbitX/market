...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("public/vendors/datatables/css/scroller.bootstrap.min.css")); ?>" />
    <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("public/vendors/datatables/css/colReorder.bootstrap.min.css")); ?>" />
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("public/vendors/datepicker/css/bootstrap-datepicker.min.css")); ?>" />
    <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("public/vendors/bootstrap-timepicker/css/bootstrap-timepicker.min.css")); ?>" />
    <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("public/vendors/bootstrap-switch/css/bootstrap-switch.min.css")); ?>" />
    
    <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("public/vendors/datetimepicker/css/DateTimePicker.min.css")); ?>" />
    <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("public/vendors/j_timepicker/css/jquery.timepicker.css")); ?>" />
    <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("public/vendors/clockpicker/css/jquery-clockpicker.css")); ?>" />
    <!-- end of plugin styles -->
    <link type="text/css" rel="stylesheet" href="<?php echo e(URL::asset("public/css/pages/colorpicker_hack.css")); ?>" />
...
<script type="text/javascript" src="<?php echo e(URL::asset("public/js/pages/simple_datatables.js")); ?>"></script>
...
<!-- end plugin scripts -->
<!--Page level scripts-->
<script type="text/javascript" src="<?php echo e(URL::asset("public/js/pages/advanced_tables.js")); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset("public/js/form.js")); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset("js/pluginjs/dataTables.tableTools.js")); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset("public/js/pages/form_elements.js")); ?>"></script>
<!-- end of global scripts-->
