                    ...
                    <div class="btn-group">
                        <div class="user-settings no-bg">
                            <button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
                                <!--img src="<?php echo e(url('/')); ?>/public/img/admin.jpg" class="admin_img2 img-thumbnail rounded-circle avatar-img" alt="avatar"-->
                                <img src="<?php echo e($global_logo); ?>" class="admin_img2 img-thumbnail rounded-circle avatar-img" alt="avatar"> 
                                <strong>Admin</strong>
