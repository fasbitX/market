...
function test(url) {
    ...
    // body...
    var name = $("#R" + url).val();
    var load_url = window.location.protocol + "//" + window.location.host + "/cryptocompare/coin/" + name;
...
setInterval(function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            //alert(data);
            var temp = '<div class="table-responsive"><table id="example1" class="table"> <thead class="flip-content"> <tr> <th>Cryptocurrency</th> <th>Price</th> <th class="numeric">24h % change</th> <th class="numeric">Volume</th> <th class="numeric">Market cap</th> <th class="numeric">24h performence</th> </tr></thead> <tbody>';
            //temp += g_data;
...
setInterval(function() {
    var cron_url = "http://18.191.39.172/cryptocompare/cron/test.php";
    $.ajax({
        type: "GET",
        url: cron_url,
        success: function(data) {
