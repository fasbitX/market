    ...
    <div class="container">
        ...
        <div class="row padding-button-sort">
            <div class="col-lg-2 content-buttons-box d-block">
                ...
                <div class="row">
                <a href="{{url('/')}}/?order-by=market" class="sort-buttton basis-button space-button text-white "> Market Cap </a>         
                </div>
                <div class="row">
                    <a href="{{url('/')}}/?order-by=score" class="sort-buttton space-button second-section-single-coin text-white basis-button" >Investment Quality </a>                
                </div>
            </div>
